...
describe('WeChatService', () => {
    ...
    beforeEach(() => {
        ...
        weChatService = new WeChatService_1.WeChatService(mockSecretStorage);
        jest.clearAllMocks();
    });
    ...
    it('should return null auth info when no stored auth', async () => {
        mockSecretStorage.get.mockResolvedValue(null);
    ...
    it('should load and parse stored auth correctly', async () => {
        ...
        mockSecretStorage.get.mockResolvedValue(JSON.stringify(mockAuth));
        await weChatService.loadAuthFromStorage();
...
//# sourceMappingURL=WeChatService.test.js.map